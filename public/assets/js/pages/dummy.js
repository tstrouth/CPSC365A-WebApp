        ...
        var tour = new Tour({
            steps: [

                {
                    ...
                    content: "<p></p><p>Welcome To<span class='popup_toggle_right'> <strong>ADMIRE ADMIN</strong></span></p>",
                    placement: "auto",
                    smartPlacement: true,
                    redirect: true,
                    backdrop: true
                ...
                {
                    element: ".toggle-left_tour",
                    placement: "auto",
                    content: "<p></p><p class='popup_toggle_right'>Click here to toggle the <strong>LEFT MENU</strong>.</p>",
                    smartPlacement: true
                },
                {
                    element: "#left",
                    content: "<p></p><p class='popup_toggle_right'>OK, Done with it !! here is the <strong>LEFT MENU</strong>.</p>",
                    placement: "left",
                    smartPlacement: true,
                    redirect: true,
                    backdrop: true
                ...
                {
                    element: ".component_tour",
                    content: "<p></p><p class='popup_toggle_right'>Here are the <strong>12 component</strong> pages.</p>",
                    placement: "left",
                    smartPlacement: true,
                    redirect: true,
                    backdrop: true
                    ...
                    element: ".widget_tour",
                    content: "<p></p><p class='popup_toggle_right'>Here are the <strong>30+ Widgets</strong>.</p>",
                    placement: "left",
                    smartPlacement: true,
                    redirect: true,
                    backdrop: true
                    ...
                    element: ".layout_tour",
                    content: "<p></p><p class='popup_toggle_right'>Here are the <strong>8</strong> different  <strong>Layouts </strong>.</p>",
                    placement: "left",
                    smartPlacement: true,
                    redirect: true,
                    backdrop: true
                ...
                {
                    element: ".message_tour",
                    content: "<p></p><p class='popup_toggle_right'>Here is the <strong>Messages</strong>.</p>",
                    placement: "left",
                    smartPlacement: true,
                    redirect: true,
                    backdrop: true
                    ...
                    element: ".notification_tour",
                    content: "<p></p><p class='popup_toggle_right'>Here is the <strong>Notifications</strong>.</p>",
                    placement: "left",
                    smartPlacement: true,
                    redirect: true,
                    backdrop: true
                    ...
                    element: ".right_toggle_tour",
                    content: "<p></p><p class='popup_toggle_right'>Click here to toggle the <strong>RIGHT MENU</strong>.</p>",
                    placement: "left",
                    smartPlacement: true,
                    redirect: true,
                    backdrop: true
                ...
                {
                    element: "#area-chart",
                    content: "<p></p><p class='popup_toggle_right'>Dashboard Statistics <strong>Chart</strong></p>",
                    placement: "left",
                    smartPlacement: true,
                    redirect: true,
                    backdrop: true
                ...
                {
                    element: ".to_do",
                    content: "<p></p><p class='popup_toggle_right'>Here is the <strong>To Do List</strong>..</p>",
                    placement: "left",
                    smartPlacement: true,
                    redirect: true,
                    backdrop: true
                ...
                },
                {
                    ...
                    content: "<p></p><p class='popup_toggle_right'>It's just like a sticky <strong>Notes</strong>.</p>",
                    placement: "left",
                    smartPlacement: true,
                    redirect: true,
                    backdrop: true
